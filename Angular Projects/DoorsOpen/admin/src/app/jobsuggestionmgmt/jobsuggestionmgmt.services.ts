...
export class AddJobTypemgmtService {
    ...
    getJobSuggestionListing(data:any){
      return this.http.post(`${environment.base_url}api/getJobSuggestions`,data, this.httpOptions);
    }

    addJobSuggestion(data : any) {
      return this.http.post(`${environment.base_url}api/addJobSuggestion`,data, this.httpOptions);
    }

    getJobSuggestionDetails(data:any) {
      return this.http.post(`${environment.base_url}api/getJobSuggestion`,data, this.httpOptions);
    }

    editJobSuggestion(data:any) {
      return this.http.post(`${environment.base_url}api/updateJobSuggestion`,data, this.httpOptions);
    }

    deleteJobSuggestion(data:any) {
      return this.http.post(`${environment.base_url}api/deleteJobSuggestion`,data, this.httpOptions);
    }
